...
"""
Extraction Script for: orofacial_exam
...
Usage:
    python orofacial_exam_extractor.py path/to/filled_form.pdf --output results.json
"""
...
def extract_from_image(client, image_path: Path, page_number: int) -> dict:
    ...
    # use the full OrofacialExamExtraction model
